    ...
    <body style="background-image:url('./images/inbg.jpg');">
        <form id="docup" enctype="multipart/form-data" name="docup" action="documents.php" method="post">
            ...
            <table class="table table-striped">
                            ...
                            <tr>
                                <td>
                                    <input type="submit" id="fpicup" name="fpicup" class="toggle btn btn-primary" value="Upload">
                                </td>
                             </tr>
              ...
              <center> <div class="jumbotron" style="width:100%; box-shadow: -3px 3px 10px #999999;   margin-top:10px;">
                      <h3>
                          <b> <font style=" font-family: Verdana;  font-size:19px;"> Declaration By The Applicant</font></b>
                           ...
                           <input type="checkbox" id="deca" name="deca" value="I accept" ><font style=" font-family: Verdana;font-size:medium">
                           I accept</font>
                           <br/>
 <br/>
                           <input type="submit" id="dec" name="dec" class="toggle btn btn-primary" onsubmit="send()">
