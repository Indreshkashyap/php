<?php
    error_reporting(0);
$getid= $_GET["id"];
$con=mysqli_connect("localhost","root","mysql","oas");
if(!isset($con))
{
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 ...
                 <td style="width:8%;"><center><font style="font-family:Arial Black; font-size:20px;">
                    CENTRAL UNIVERSITY BILASPUR CHHATTISGARH</font></center>
                ...
                <center><font style="font-family:Arial Black; font-size:20px;">
                   CU ADMIT CARD (2020-21)</font></center>
                </td>
                 ...
                 <td style="width:4%;"> <font style="font-family: Verdana;">Date</font> </td>
                    <td style="width:8%;" colspan="3"><font style="font-family: Verdana; font-weight: bold">
                        10th May 2021, Afternoon Session</font> </td>
                 </tr>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td style="width:8%;" colspan="3">
                       <font style="font-family: Verdana; font-weight: bold"> CENTRAL UNIVERSITY BILASPUR<br>
                        At - Koni<br>
                        P.O - Koni, Bilaspur<br>
                        Dist: Bilaspur - 495330<br>
                        CG, India<br>
