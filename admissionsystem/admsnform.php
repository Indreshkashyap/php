                   ...
                   <td colspan="3">
                       <table class="table table-hover">
                           ...
                           <tr>
                               ...
                               <td colspan="3">
                                    <input type="radio" id="pay" name="pay" value="Loan"><font style="font-family: Verdana;">Online</font>
                                    <input type="radio" id="pay" name="pay" value="Self"><font style="font-family: Verdana;">Offline</font>
                               </td>
                           </tr>
